...
def gaussian_blur_3d(
    ...
    This was the most general of the four Gaussian blurs in the repository, so it is
    the one that became ``smauglab.transforms.kernels.gaussian_blur3d``. The name here
    is kept because ``FN.gaussian_blur_3d`` is part of this module's ``__all__``.
    """
