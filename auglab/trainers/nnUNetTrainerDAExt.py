            ...
            for epoch in range(self.current_epoch, self.num_epochs):
                ...
                with torch.no_grad():
                    ...
                    for val_idx, val_output in enumerate(val_outputs):
                        ...
                        self.ema_dice_validation[val_idx] = self.ema_dice_validation[val_idx] * 0.9 + 0.1 * mean_fg_dice if self.ema_dice_validation[val_idx] is not None else mean_fg_dice
                        if val_idx == 0:
